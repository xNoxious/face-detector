...
class Profile extends React.Component {
    constructor(props) {
        ...
        // We keep state here because if we send it back to App.js 
        // it will trigger re-render of whole app as user is typing
        // Only send state to App.js when we click 'Save' button
        this.state = {
    ...
    onProfileUpdate = (data) => {
        fetch(`https://lit-dusk-83072.herokuapp.com/profile/${this.props.user.id}`, {
            method: 'post',
            headers: {
            ...
            <div className="profile-modal">
                <article className="br3 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white">
                    <main className="pa4 black-80 w-80">
                        ...
                        <p>{`Member since: ${new Date(user.joined).toLocaleDateString('en-UK')}`}</p>
